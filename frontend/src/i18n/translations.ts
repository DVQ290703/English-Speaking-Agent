...
export const TRANSLATIONS: Record<Lang, Dict> = {
  en: {
    ...
    "category.IELTS Speaking.desc":
      "Practise official IELTS-style speaking parts.",
    "category.Business & Career.name": "Business & Career",
    "category.Business & Career.desc":
      "Workplace English and professional speaking.",
    ...
    "category.Travel & Culture.desc":
      "From booking flights to cross-cultural chats.",

    // Topic cards
    "topic.IELTS Part 1.title": "IELTS Part 1 — Intro",
    "topic.IELTS Part 1.desc":
      "Personal questions about you and familiar topics.",
    ...
    "topic.Academic Discussion.desc":
      "Part 3 style — opinions, comparisons, abstract topics.",
    "topic.Describe a person.title": "Describe a Person",
    "topic.Describe a person.desc":
      "Vocabulary for character, appearance, relationships.",
    "topic.Describe a place.title": "Describe a Place",
    "topic.Describe a place.desc":
      "City, country, landmark, favourite location.",
    ...
    "topic.Office Meeting.desc":
      "Discuss projects, share opinions, agree/disagree.",
    ...
    "topic.Negotiation.desc":
      "Bargain politely, propose terms, reach agreement.",
    ...
    "topic.Daily Conversation.desc":
      "Hobbies, family, weekend plans, weather.",
    ...
    "topic.Family & Friends.desc":
      "Relationships, gatherings, personal stories.",
    ...
    "topic.Food & Restaurant.desc":
      "Order, describe taste, ask about dishes.",
    "topic.Hotel & Booking.title": "Hotel & Booking",
    "topic.Hotel & Booking.desc":
      "Check-in, request services, handle problems.",
    "topic.Culture & Customs.title": "Culture & Customs",
    "topic.Culture & Customs.desc":
      "Compare traditions and cross-cultural topics.",
    "topic.Airport English.title": "Airport English",
    "topic.Airport English.desc":
      "Check-in, security, customs vocabulary.",
    ...
    "va.left.feedbackEmptyDisconnected":
    ...
    "va.input.statusHint":
      "{n} messages • Enter to send, Shift+Enter for newline",

    // VoiceAgent — settings overlay
    "va.settings.title": "Practice topic",
    "va.settings.subtitle":
      "Choose a topic so the AI can guide you in the right direction",
    ...
    "va.alert.noSignal":
      "No signal from the microphone. Please check your recording device.",
    ...
    "va.alert.recognitionFailed":
      "Speech recognition could not start: {detail}",
  ...
  vi: {
    ...
    "dash.topics.subtitle":
      "Duyệt theo danh mục và chọn chủ đề bạn muốn luyện hôm nay.",
    ...
    "category.IELTS Speaking.name": "IELTS Speaking",
    "category.IELTS Speaking.desc":
      "Luyện các dạng nói chính thức theo phong cách IELTS.",
    "category.Business & Career.name": "Công việc & Sự nghiệp",
    "category.Business & Career.desc":
      "Tiếng Anh nơi làm việc và giao tiếp chuyên nghiệp.",
    ...
    "category.Travel & Culture.desc":
      "Từ đặt vé máy bay đến trò chuyện liên văn hóa.",

    // Topic cards
    "topic.IELTS Part 1.title": "IELTS Part 1 — Giới thiệu",
    "topic.IELTS Part 1.desc":
      "Câu hỏi cá nhân về bản thân và các chủ đề quen thuộc.",
    ...
    "topic.Academic Discussion.desc":
      "Phong cách Part 3 — quan điểm, so sánh, chủ đề trừu tượng.",
    "topic.Describe a person.title": "Tả người",
    "topic.Describe a person.desc":
      "Từ vựng về tính cách, ngoại hình, mối quan hệ.",
    "topic.Describe a place.title": "Tả nơi chốn",
    "topic.Describe a place.desc":
      "Thành phố, đất nước, địa danh, nơi yêu thích.",
    "topic.Job Interview.title": "Phỏng vấn xin việc",
    "topic.Job Interview.desc":
      "Câu hỏi thường gặp và cách trả lời có cấu trúc.",
    "topic.Office Meeting.title": "Họp công ty",
    "topic.Office Meeting.desc":
      "Bàn dự án, chia sẻ ý kiến, đồng ý/phản đối.",
    "topic.Presentations.title": "Thuyết trình",
    "topic.Presentations.desc":
      "Mở đầu, sắp xếp và kết thúc một bài nói ngắn.",
    "topic.Negotiation.title": "Đàm phán",
    "topic.Negotiation.desc":
      "Mặc cả lịch sự, đề xuất điều khoản, đạt thỏa thuận.",
    ...
    "topic.Travel & Tourism.desc":
      "Đặt chỗ, hỏi đường, kể chuyện đi chơi.",
    ...
    "topic.Hotel & Booking.desc":
      "Nhận phòng, yêu cầu dịch vụ, xử lý sự cố.",
    "topic.Culture & Customs.title": "Văn hóa & Phong tục",
    "topic.Culture & Customs.desc":
      "So sánh truyền thống và chủ đề liên văn hóa.",
    ...
    "va.left.noIssues":
      "Tuyệt vời! Không phát hiện lỗi nào trong câu này.",
    "va.left.feedbackEmptyConnected":
      "Gửi tin nhắn để xem phản hồi cho câu mới nhất của bạn ở đây.",
    "va.left.feedbackEmptyDisconnected":
      "Kết nối để xem chỉnh sửa tiếng Anh theo thời gian thực",
    ...
    "va.input.statusHint":
      "{n} tin nhắn • Enter để gửi, Shift+Enter để xuống dòng",
    ...
    "va.alert.micNotFound":
      "Không tìm thấy thiết bị micro. Hãy cắm micro hoặc chọn thiết bị khác.",
    "va.alert.micBusy":
    ...
    "va.alert.noSignal":
      "Không bắt được tín hiệu từ micro. Kiểm tra lại thiết bị thu âm.",
    "va.alert.recogGivingUp":
      "Nhận dạng giọng nói liên tục lỗi. Hãy thử mở app ở tab mới (Chrome/Edge) và cấp quyền micro.",
    "va.alert.connectFailed":
      "Không thể bắt đầu phiên. Hãy kiểm tra micro và thử lại.",
    "va.alert.recognitionFailed":
      "Không khởi động được nhận dạng giọng nói: {detail}",
